  ...
  return (
    <footer className="bg-[black] lg:flex flex-col justify-center py-6 text-lg hidden">
      <div className="text-center text-redlighter">
        <p>
          ScannerCam is powered by TensorFlow.js - Machine Learning in your
          browser
        </p>
      </div>
      <div className="flex flex-row gap-x-4 justify-center py-2">
        ...
        <a
          href="https://github.com/360macky/scanner-cam#-contributing"
          className="text-[white] hover:underline"
        >
          {t('footer.contribution')}
        </a>
        <a
          href="https://github.com/360macky/scanner-cam/issues"
          className="text-[white] hover:underline"
        >
          {t('footer.issues')}
        </a>
