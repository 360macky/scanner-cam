...
function Footer({ t }: FooterProps) {
  return (
    <footer className="p-4 bg-white shadow md:flex-col md:items-center md:justify-between md:p-6 md:pb-12 dark:bg-reddark">
      ...
      <div className="flex gap-x-2 py-4">
        <Image src={TensorFlowImage} height={25} alt="" />
        <Image src={NextImage} height={25} alt="" />
        <Image src={ReactImage} height={25} alt="" />
      </div>
    </footer>
  )
}
